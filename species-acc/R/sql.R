...
# key <- '0053545-250920141307145' # DK 

key <- '0054121-250920141307145' # CO 
...
# ggsave("species-acc/plots/DK-sp-acc.png", p, width = 10, height = 6, units = "in")
ggsave("species-acc/plots/CO-sp-acc.png", p, width = 10, height = 6, units = "in")
