...
# '0032846-250920141307145' # AU

d <- occ_download_get('0043088-250920141307145') %>% 
    occ_download_import() |>   
...
ggsave(p, filename = "species-count-maps/plots/BW-sp-counts.png", width = 12, height = 8,dpi=900)
