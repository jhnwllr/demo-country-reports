...
key <- "0054037-250920141307145" # CO 
# key <- "0053432-250920141307145" # DK 
...
save(chao1_results, file = "diversity-metrics/chao1_results_DK.rda")

# Load chao1_results from RDA file
load("diversity-metrics/chao1_results_DK.rda")
...
p <- ggplot() +
  ...
  scale_fill_viridis_c(
    ...
    labels = function(x) ifelse(x == cutoff, ">10K", paste0(x/1000, "K"))
  ) +
  theme_minimal() +
  theme(
