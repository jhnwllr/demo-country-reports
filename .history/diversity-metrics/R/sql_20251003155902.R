...
d <- occ_download_get('0043181-250920141307145') %>% 
    occ_download_import() |>   
...
save(chao1_results, file = "diversity-metrics/chao1_results_COL.rda")

# Load chao1_results from RDA file
load("diversity-metrics/chao1_results_COL.rda")
...
ggsave(p, filename = "diversity-metrics/plots/COL-chao1.png", width = 12, height = 8, dpi = 900)
