...
sf_obj <- sf::st_read("ISEA3H-shapefiles/resolution-8/")

p <- ggplot() +
geom_sf(data=sf_obj) +
theme_minimal()

# ggsave(p, filename = "ISEA3H-shapefiles/grid_8.svg", width = 12, height = 5)
ggsave(p, filename = "ISEA3H-shapefiles/grid_8.png", width = 12, height = 5,res=600)
