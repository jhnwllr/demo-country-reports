...
grid_points$cell <- tibble::as_tibble(dgGEO_to_SEQNUM(dggs, grid_points$lon, grid_points$lat)$seqnum)

grid_points <- tibble::as_tibble(grid_points)

# tibble::as_tibble(dgSEQNUM_to_GEO(dggs,grid_points$cell)) 
