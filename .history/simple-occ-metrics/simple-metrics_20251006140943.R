...
species = rgbif::occ_count(country=cc,facet="speciesKey",facetLimit=1000000) |> nrow()
families = rgbif::occ_count(country="AU",facet="familyKey",facetLimit=1000000) |> nrow()
