...
glimpse() 
  ...
  dplyr::rename(
    occurrence_count_2024 = occurrence_count.x,
    occurrence_count_2025 = occurrence_count.y,
    distinct_species_count_2024 = distinct_species_count.x,
    distinct_species_count_2025 = distinct_species_count.y
  ) %>%
  dplyr::mutate(
