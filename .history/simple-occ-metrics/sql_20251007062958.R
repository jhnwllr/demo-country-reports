...
SELECT 
  countryCode,
  CASE 
    WHEN year BETWEEN 1600 AND 2024 THEN '1600-2024'
    WHEN year BETWEEN 1600 AND 2025 THEN '1600-2025'
    ELSE 'other_years'
  END AS year_group,
  CASE 
...
WHERE countryCode IN ('BW', 'CO', 'DK', 'AU')
  AND year BETWEEN 1600 AND 2025
GROUP BY 
  countryCode,
  CASE 
    WHEN year BETWEEN 1600 AND 2024 THEN '1600-2024'
...
d <- occ_download_get('0056353-250920141307145') %>%
    occ_download_import()
