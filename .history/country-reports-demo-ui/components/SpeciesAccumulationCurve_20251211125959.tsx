  ...
  return (
    <div className="flex justify-center">
      ...
      {hoveredPoint && (
        ...
        >
          <div className="bg-white text-gray-800 px-3 py-2 rounded-md shadow-lg border border-gray-300">
            <div className="text-xs font-semibold mb-0.5">Year {hoveredPoint.year}</div>
            <div className="text-xs">{hoveredPoint.species.toLocaleString()} species</div>
            <div className="text-xs text-gray-600 mt-1">
              {hoveredPoint.effort.toLocaleString()} occurrence records
            </div>
          </div>
        </div>
      )}
