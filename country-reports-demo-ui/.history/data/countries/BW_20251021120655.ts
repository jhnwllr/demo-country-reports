...
const speciesRichnessImageBW = "/data/images/BW-species-richness.svg?v=" + Date.now();
const chao1ImageBW = "/data/images/BW-chao1.svg?v=" + Date.now();
const accumulationCurveImageBW = "/data/images/BW-accumulation.svg?v=" + Date.now();
