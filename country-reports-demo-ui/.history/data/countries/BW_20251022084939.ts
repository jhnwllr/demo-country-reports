...
const speciesRichnessImageBW = "/data/images/species-richness/BW-species-richness.svg?v=" + Date.now();
const chao1ImageBW = "/data/images/chao1/BW-chao1.svg?v=" + Date.now();
const accumulationCurveImageBW = "/data/images/species-accumulation/BW-accumulation.svg?v=" + Date.now();
