...
const chao1Image = '/data/images/chao1-explainer.png';
    ...
    <div className="max-w-4xl mx-auto p-12 bg-white min-h-screen">
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            Species richness across {currentCountry.name} comparing expected
            values (Chao1 estimator) with unique species counts for each grid cell from
            occurrence records. These counts only include plants and animals. The Chao1
            estimator accounts for undetected species by analyzing rare species 
            (singletons and doubletons) to provide a more complete picture of biodiversity.
            If underestimation is expected, the hexagon is filled in gray.
          </CardDescription>
        </CardHeader>
        <CardContent className="overflow-hidden">
          ...
          <div className="mt-6 px-4 py-3 bg-gray-50 rounded-lg border-l-4 border-blue-400">
            <p className="text-xs text-gray-700">
              ...
              occurrence counts alone. These counts only include 
              plants and animals. If underestimation is expected, 
