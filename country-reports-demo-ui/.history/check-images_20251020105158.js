...
// List of expected image files based on the application structure
const expectedImages = [
  ...
  // Australia
  'australia-accumulation.png',
  'australia-chao1.png', 
  'australia-species-richness.png',
  
  // Botswana
  'botswana-accumulation.png',
  'botswana-chao1.png',
  'botswana-species-richness.png',
  
  // Denmark
  'denmark-accumulation.png',
  'denmark-chao1.png',
  'denmark-species-richness.png',
  
  // Colombia
  'colombia-accumulation.png',
  'colombia-chao1.png',
  'colombia-species-richness.png'
];
