...
const denmarkSpeciesRichness = '/data/images/DK-species-richness.png?v=' + Date.now();
const denmarkChao1 = '/data/images/DK-chao1.png?v=' + Date.now();
const denmarkAccumulation = '/data/images/DK-accumulation.png';
const colombiaSpeciesRichness = '/data/images/CO-species-richness.png?v=' + Date.now();
const colombiaChao1 = '/data/images/CO-chao1.png?v=' + Date.now();
