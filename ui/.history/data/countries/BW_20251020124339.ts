...
const speciesRichnessImageBW = "/data/images/BW-species-richness.svg?v=2";
const chao1ImageBW = "/data/images/BW-chao1.svg?v=2";
const accumulationCurveImageBW = "/data/images/BW-accumulation.svg?v=2";
