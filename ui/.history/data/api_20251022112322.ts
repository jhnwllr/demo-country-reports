...
const image_7939edfec694d8328b1c52b88c2e0562f61fb835 = '/data/images/species-accumulation/BW-accumulation.png';
const image_0b3ff0d2596d1053d3859a50cdaab2ed44428b71 = '/data/images/species-richness/BW-species-richness.png';
const image_1733de95b04e2a57294a1506cc4e7fe0e5eabf0e = '/data/images/chao1/BW-chao1.png';
...
const image_18d645e7f1bff2b60e0255aad48038c90765b0ad = '/data/images/species-accumulation/AU-accumulation.png?v=' + Date.now();
const image_9a043df07abe015f495e424aac91e01fd5704c62 = '/data/images/chao1/AU-chao1.png?v=' + Date.now();
const image_642c8876bc4ea5b283e242b29883cc39f7b92f88 = '/data/images/species-richness/AU-species-richness.png?v=' + Date.now();
const denmarkSpeciesRichness = '/data/images/species-richness/DK-species-richness.png?v=' + Date.now();
const denmarkChao1 = '/data/images/chao1/DK-chao1.png?v=' + Date.now();
const denmarkAccumulation = '/data/images/species-accumulation/DK-accumulation.png';
const colombiaSpeciesRichness = '/data/images/species-richness/CO-species-richness.png?v=' + Date.now();
const colombiaChao1 = '/data/images/chao1/CO-chao1.png?v=' + Date.now();
const colombiaAccumulation = '/data/images/species-accumulation/CO-accumulation.png';
...
export const getCountryImagePath = (countryCode: string, imageType: 'accumulation' | 'chao1' | 'species-richness'): string => {
  ...
  return `/data/images/${folderMap[imageType]}/${countryCode}-${imageType}.png`;
};
